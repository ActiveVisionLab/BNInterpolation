...
Modified by gwpd:
    Added second output of network features before last linear layer in
        ResNet()'s forward().

Originally downloaded on 20 February 2018 from
https://raw.githubusercontent.com/akamaster/pytorch_resnet_cifar10/master/resnet.py
"""
